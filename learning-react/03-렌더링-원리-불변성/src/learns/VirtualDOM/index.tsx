    ...
    <section className={S.container}>
      ...
      <div className={S.comparisonGrid}>
        ...
        <article className={S.box}>
          ...
          />
          <button type="button" className={`${S.button} ${S.reactBtn}`} onClick={()=> setCount ((c) => c + 1 ) }>
            리액트 업데이트
          </button>
          <p className={S.desc}>
        ...
        <article className={S.box}>
          ...
          <button type="button" className={`${S.button} ${S.vanillaBtn}`} onClick={handleVanillaUpdate}>
