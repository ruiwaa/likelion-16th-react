  ...
  return (
    <section className="w-full space-y-12">
      ...
      <nav
        ...
        className="flex h-10 items-center gap-x-1 font-bold text-slate-400"
      >
          ...
          return (
            <Fragment key={index}>
              ...
              <Link
                href={href}
                className={cn(
                  'rounded-full border py-1 transition-all',
                  isFirst ? 'pr-4 pl-2' : 'px-4',
                  isLast
      ...
      <header className="space-y-5">
        <div
          className={cn(
            'inline-flex items-center gap-2 rounded-full border border-blue-500 bg-blue-50',
        ...
        >
          {lastSubjectTitle}에 대한 심화 학습을 위해 하위 주제를 선택하세요.
        </p>
      </header>
    </section>
  )
