...
import { createItemAction } from '../actions/create-item-actions'
 ...
 *
 * 사용 방법
 * - [상태, 액션함수, 대기상태] = useActionState(서버액션:리듀서_액션, 초기상태)
 * - 폼의 <form action={액션함수}>에 연결하여 사용합니다.
 */

// 부모(key 관리자, key 업데이트 관리)
...
function CreateActionForm({ onReset }: CreateActionFormProps) {
    ...
    return (
      ...
      >
        <div className="relative z-10">
          ...
          {!state.message ? (
            <form
              action={dispatchAction} //Post 요청을 next.js서버에 함
